@if (!$status)
    <a class="btn btn-action btn-sm" onclick="openModal(1,{{$id}})" type="button"><i class="bi bi-eye-fill"></i></a>
    <a class="btn btn-action btn-sm" onclick="openModal(2,{{$id}})" type="button"><i class="bi bi-pen-fill"></i></a>
