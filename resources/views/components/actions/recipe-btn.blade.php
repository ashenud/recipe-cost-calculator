@if (!$status)
    ...
    <a class="btn btn-action btn-sm" href="{{route($route_pdf,array('id'=>$id))}}" type="button" target="_blank"><i class="bi bi-file-earmark-pdf-fill"></i></a>
    {{-- <a class="btn btn-action btn-sm" href="{{route($route_edit,array('id'=>$id))}}" type="button" target="_blank"><i class="bi bi-pen-fill"></i></a> --}}
